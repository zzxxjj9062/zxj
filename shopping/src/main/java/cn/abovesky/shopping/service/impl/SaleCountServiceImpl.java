...
public class SaleCountServiceImpl implements ISaleCountService {
    ...
    public Map<String, Integer> saleCount(BaseConditionVO vo) {
        Map<String, Integer> map = this.getSaleCountMap(vo.getStatus());
        ...
        for (SaleCount saleCount : saleCountList) {
            map.put(saleCount.getDate(), saleCount.getNumber());
        }
        return map;
    }
    ...
    private Map<String, Integer> getSaleCountMap(String status) {
