...
public class AOrderController extends ComOrderController {
    ...
    public ModelAndView list(BaseConditionVO vo) {
        ...
        modelAndView.addObject("weekTotalPrice", saleRecordService.countTotalPrice(vo, "1"));
        modelAndView.addObject("monthTotalPrice", saleRecordService.countTotalPrice(vo, "2"));
        modelAndView.addObject("yearTotalPrice", saleRecordService.countTotalPrice(vo, "3"));
        return modelAndView;
    }
}
