...
<form method="post" rel="pagerForm" action="${pageContext.request.contextPath}/merchant/goods/list.html" onsubmit="return navTabSearch(this);">
...
<div class="pageContent">
    ...
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" rel="add_goods" target="navTab" href="${pageContext.request.contextPath}/merchant/goods/addView.html"><span>添加菜品</span></a></li>
            <li><a class="edit" target="navTab" href="${pageContext.request.contextPath}/merchant/goods/edit/{goods_id}.html"><span>修改</span></a></li>
            <li><a title="确定要删除这些菜品吗?" target="selectedTodo" warn="您没有选择菜品" rel="ids" href="${pageContext.request.contextPath}/merchant/goods/delete.html" class="delete"><span>删除</span></a></li>
            <li class="line">line</li>
            <li><a title="确定要上架这些菜品吗?" target="selectedTodo" warn="您没有选择菜品" rel="ids" href="${pageContext.request.contextPath}/merchant/goods/up.html" class="add"><span>上架</span></a></li>
            <li><a title="确定要下架这些菜品吗?" target="selectedTodo" warn="您没有选择菜品" rel="ids" href="${pageContext.request.contextPath}/merchant/goods/down.html" class="delete"><span>下架</span></a></li>
        </ul>
    </div>
