...
<form method="post" rel="pagerForm" action="${pageContext.request.contextPath}/merchant/order/list.html" onsubmit="return navTabSearch(this);">
        ...
        <div class="searchBar">
            ...
            <div class="subBar">
                <span style="line-height: 25px; float: left">
                    ...
                    本周营业额：<strong>${weekTotalPrice}</strong>元　　
                    本月营业额：<strong>${monthTotalPrice}</strong>元　　
                    今年营业额：<strong>${yearTotalPrice}</strong>元　　
                    收藏数：<strong>${collectionCount}</strong>
                </span>
                <ul>
...
<div class="pageContent">
    ...
    <div class="panelBar">
        <ul class="toolBar">
            <li><a title="确认配送这些订单吗?" target="selectedTodo" warn="您没有选择订单" rel="ids" href="${pageContext.request.contextPath}/merchant/order/confirmSend.html" class="add"><span>确认配送</span></a></li>
            <li><a title="确定要取消这些订单吗?" target="selectedTodo" warn="您没有选择订单" rel="ids" href="${pageContext.request.contextPath}/merchant/order/cancel.html" class="delete"><span>取消订单</span></a></li>
            <li><a title="确定要配送这些订单吗?" target="selectedTodo" warn="您没有选择订单" rel="ids" href="${pageContext.request.contextPath}/merchant/order/send.html" class="edit"><span>配送</span></a></li>
        </ul>
    </div>
