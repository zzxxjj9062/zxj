...
<div class="pageContent">
    <form method="post" action="${pageContext.request.contextPath}/manage/merchant/update.html" class="pageForm required-validate" onsubmit="return iframeCallback(this, navTabAjaxDone);" enctype="multipart/form-data">
        ...
        <div class="pageFormContent nowrap" layoutH="56">
            <dl>
                <dt>店铺名：</dt>
                <dd>
                    <input type="text" name="storeName" class="required" value="${merchant.storeName}" minlength="2" maxlength="20" remote="${pageContext.request.contextPath}/manage/merchant/checkStoreName?oldStoreName=${merchant.storeName}"/>
                </dd>
            </dl>
            <dl>
                <dt>店铺描述：</dt>
